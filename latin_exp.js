...
async function experimentInit() {
  ...
  let setupClock = new util.Clock();
  // Run 'Begin Experiment' code from setup_code
  let list_version = [1, 2][Math.floor(Math.random() * 2)];
  
  if ((list_version === 1)) {
      let lang_map = {"A": "RU", "B": "EN"};
  } else {
      lang_map = {"A": "EN", "B": "RU"};
  }
  ...
  let text_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_2',
  ...
  let proceed = new core.Keyboard({psychoJS: psychoJS, clock: new util.Clock(), waitForStart: true});
  
  // Initialize components for Routine "trial"
  let trialClock = new util.Clock();
  let text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: '',
    font: 'Arial',
  ...
  let image = new visual.ImageStim({
    win : psychoJS.window,
  ...
  let proceed_2 = new core.Keyboard({psychoJS: psychoJS, clock: new util.Clock(), waitForStart: true});
  
  // Initialize components for Routine "ratings_ru"
  let ratings_ruClock = new util.Clock();
  let Credibility = new visual.Slider({
  ...
  let Familiarity = new visual.Slider({
  ...
  let key_resp = new core.Keyboard({psychoJS: psychoJS, clock: new util.Clock(), waitForStart: true});
  
  let cred_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'cred_text',
  ...
  let fam_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'fam_text',
  ...
  let val_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'val_text',
  ...
  let text_continue = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_continue',
  ...
  let corr_ruClock = new util.Clock();
  let image_2 = new visual.ImageStim({
    win : psychoJS.window,
  ...
  let rate_corr_ruClock = new util.Clock();
  let cred_corr = new visual.Slider({
  ...
  let text_cred = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_cred',
  ...
  let conf_corr = new visual.Slider({
  ...
  let text_conf = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_conf',
  ...
  let press = new core.Keyboard({psychoJS: psychoJS, clock: new util.Clock(), waitForStart: true});
  
  let proc = new visual.TextStim({
    win: psychoJS.window,
    name: 'proc',
    text: 'После оценивания нажмите ПРОБЕЛ для продолжения.',
    font: 'Arial',
  ...
  let ratings_enClock = new util.Clock();
  let Credibility_2 = new visual.Slider({
  ...
  let Familiarity_2 = new visual.Slider({
  ...
  let Valence_2 = new visual.Slider({
  ...
  let Understanding = new visual.Slider({
  ...
  let key_resp_2 = new core.Keyboard({psychoJS: psychoJS, clock: new util.Clock(), waitForStart: true});
  
  let cred_text_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'cred_text_2',
  ...
  let fam_text_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'fam_text_2',
  ...
  let val_text_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'val_text_2',
  ...
  let und_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'und_text',
  ...
  let text_continue_2 = new visual.TextStim({
    win: psychoJS.window,
  ...
  let corr_enClock = new util.Clock();
  let image_3 = new visual.ImageStim({
    win : psychoJS.window,
  ...
  let corr_2 = new visual.ImageStim({
    win : psychoJS.window,
  ...
  let rate_corr_enClock = new util.Clock();
  let cred_corr_2 = new visual.Slider({
  ...
  let text_cred_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_cred_2',
  ...
  let conf_corr_2 = new visual.Slider({
  ...
  let text_conf_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_conf_2',
  ...
  let press_2 = new core.Keyboard({psychoJS: psychoJS, clock: new util.Clock(), waitForStart: true});
  
  let proc_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'proc_2',
    text: 'After rating the statement, press SPACE to continue.',
    font: 'Arial',
  ...
  let osfClock = new util.Clock();
  let text_wait = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_wait',
  ...
  let globalClock = new util.Clock();  // to track the time since experiment started
  let routineTimer = new util.CountdownTimer();  // to track time remaining of each (non-slip) routine
...
function InstructionRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.reset();
    let InstructionMaxDurationReached = false;
    // update component parameters for each repeat
    ...
    let InstructionMaxDuration = null
    // keep track of which components have finished
...
function trialRoutineBegin(snapshot) {
  return async function () {
    ...
    let current_set = Set;
    let current_lang = lang_map[current_set];
    if ((current_lang === "RU")) {
        let headline = ru_pic;
        let instruction_text = "Нажмите ПРОБЕЛ для продолжения.";
    } else {
        if ((current_lang === "EN")) {
            headline = en_pic;
            instruction_text = "Press SPACE to continue.";
        } else {
            let trial_text = "ERROR: language not defined";
        }
    }
...
function ratings_ruRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.reset();
    let ratings_ruMaxDurationReached = false;
    // update component parameters for each repeat
    ...
    let ratings_ruMaxDuration = null
    // keep track of which components have finished
...
function corr_ruRoutineBegin(snapshot) {
  return async function () {
    ...
    let corr_ruMaxDurationReached = false;
    // update component parameters for each repeat
    // Run 'Begin Routine' code from corr_code
    continueRoutine = (current_lang === "RU");
    if ((text_veracity === "T")) {
        let corr_img = "corrections/ru_true.png";
    } else {
        if ((text_veracity === "F")) {
...
function corr_ruRoutineEachFrame() {
  return async function () {
    ...
    let frameRemains = 0.0 + 3 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
...
function rate_corr_ruRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.reset();
    let rate_corr_ruMaxDurationReached = false;
    // update component parameters for each repeat
    ...
    let rate_corr_ruMaxDuration = null
    // keep track of which components have finished
...
function ratings_enRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.reset();
    let ratings_enMaxDurationReached = false;
    // update component parameters for each repeat
    ...
    let ratings_enMaxDuration = null
    // keep track of which components have finished
...
function corr_enRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.add(3.000000);
    let corr_enMaxDurationReached = false;
    // update component parameters for each repeat
...
function rate_corr_enRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.reset();
    let rate_corr_enMaxDurationReached = false;
    // update component parameters for each repeat
    ...
    let rate_corr_enMaxDuration = null
    // keep track of which components have finished
...
function osfRoutineBegin(snapshot) {
  return async function () {
    ...
    let osfMaxDurationReached = false;
    // update component parameters for each repeat
